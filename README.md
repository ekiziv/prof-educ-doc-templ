This app can be run by 'streamlit run applications.py'. 
...
For debug mode, please use
```
streamlit run application.py --server.enableCORS false --server.enableXsrfProtection false -- --debug
```

You can find this app at https://razilya.streamlit.app/. 
